        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}"); ?>" method="post">
            <table class='table table-hover table-responsive table-bordered'>
                ...
                <tr>
                    ...
                    <td>
                        <input type='text' name='promotion_price' class='form-control' value="<?php echo htmlspecialchars($promotion_price, ENT_QUOTES);  ?>" />
                    </td>
                </tr>
                <tr>
                    <td>Manufacture Date</td>
                    <td>
                        <input type='date' name='manufacture_date' class='form-date' value="<?php echo htmlspecialchars($manufacture_date, ENT_QUOTES);  ?>" />
                    </td>
                </tr>
                <tr>
                    <td>Expired Date</td>
                    <td>
                        <input type='date' name='expired_date' class='form-date' value="<?php echo htmlspecialchars($expired_date, ENT_QUOTES);  ?>" />
                    </td>
                </tr>
                <tr>
                    <td></td>
